...
void Init_Port1(void) { // Configure Port 2
//------------------------------------------------------------------------------
...
void Init_Port3(void) { // Configure Port 2
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
     ...
     P4IFG  &= ~SW1;                 // P4.1 IFG SW1 cleared
...
//------------------------------------------------------------------------------
    ...
    P5DIR = 0x00;                    // Set P1 direction to output
...
//------------------------------------------------------------------------------
    ...
    P6DIR = 0x00;                    // Set P1 direction to output
